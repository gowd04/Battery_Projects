...
% values taken from "Thermal Model for Lithium Ion Battery Pack with Mixed Parallel and Series Configuration"
...
% values taken from "Thermal Model for Lithium Ion Battery Pack with Mixed Parallel and Series Configuration"
% Ea_rp       = 5.8e4;     %activation energy for reaction for positive electrode (J/mol);
% Ea_rn       = 2.0e4;     %activation energy for reaction for negative electrode (J/mol);
...
% Ds_n_ref    = 5.5e-14;  % Diffusion coefficient of solid phase in negative electrode (m^2/s)
% Ds_p_ref    = 1e-11;    % Diffusion coefficient of solid phase in positive electrode (m^2/s)
...
% %kn_sei_ref      = 0; 
% kn_sei_ref      = 55e-19;    % Rate constant for SEI layer formation in negative electrode (m/s)
% kn_plating_ref  = 55e-19;     % Rate constant for Li plating in negative electrode (m/s)
...
k_cond_plating   = 1.1e07;     % Conductivity of plated Li (S/m)

%% Operating conditions

% T_init      = 318.15;  	% Temperature (K)
Tref        = 298.15;
