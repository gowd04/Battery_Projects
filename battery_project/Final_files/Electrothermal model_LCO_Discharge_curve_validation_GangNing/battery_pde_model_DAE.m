...
kp_arr  = kp_ref*exp((-Ea_rp/R)*((1./(T_p*Ta))-(1/Ta))); % rate constant for positive electrode
kn1_arr = kn1_ref*exp((-Ea_rn/R)*((1./(T_n*Ta))-(1/Ta)));
kn2_arr = kn2_ref*exp((-Ea_rp/R)*((1./(T_p*Ta))-(1/Ta)));
kn_sei_arr  = kn_sei_ref*exp((-Ea_rn/R)*((1./(T_n*Ta))-(1/Ta)));
kn_plating_arr = kn_plating_ref*exp((-Ea_rn/R)*((1./(T_n*Ta))-(1/Ta)));
...
elseif Index_chdisch == 4
    ...
    %% Final expression
    dydt = [dC1p_dt; dC1n_dt; dC2p_dt; dC2m_dt; dC2n_dt; ...
        dP1p_dt; dP1n_dt; dP2p_dt; dP2m_dt; dP2n_dt; dC3p_dt; dC3n_dt;dTdt; dJpidt; dJnidt_des; dJnidt_sei];
